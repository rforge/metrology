...
mandel.kh <- function(x, g=NULL, m=NULL, na.rm=T, rowname=NULL, type=c("h", "k"), n=NA, ...) {
	UseMethod("mandel.kh")
}

mandel.kh.default <- function(x, g=NULL, m=NULL, na.rm=T, rowname=NULL, type=c("h", "k"), n=NA, ...) {
	...
	mkh<-mandel.kh(x=x, g=g, m=m, na.rm=na.rm, rowname=rowname, type=type, n=n, ...)

	attr(mkh, "grouped.by") <- name.g
	return(mkh)
}

mandel.kh.array <- function(x, g=NULL, m=NULL, na.rm=T, rowname=NULL, type=c("h", "k"), n=NA, ...) {
...
mandel.kh.matrix <- function(x, g=NULL, m=NULL, na.rm=T, rowname=NULL, type=c("h", "k"), n=NA, ...) {

	mkh<-mandel.kh(x=as.data.frame(x), g=g, m=m, na.rm=na.rm, rowname=rowname, type=type, n=n, ...)
...
mandel.kh.data.frame <- function(x, g=NULL, m=NULL, na.rm=T, rowname=NULL, type=c("h", "k"), n=NA, ...) {
	...
	if(type[1]=="h") {
		...
		mkh <- as.data.frame( lapply(x[,2:ncol(x), drop=FALSE], h, na.rm=na.rm) )
	} else if(type[1]=="k") {
...
mandel.kh.ilab <- function(x, g=NULL, m=NULL, na.rm=T, rowname=NULL, type=c("h", "k"), n=NA, ...) {

	name.g <- .get.mandel.rowname(deparse(substitute(g)), rowname)
	
	mkh<-mandel.kh(x=x$data$x, g=g, m=x$data$measurand, na.rm=na.rm, rowname=rowname, type=type, n=n, ...)
...
mandel.h <- function(x, g=NULL, m=NULL, na.rm=T, rowname=NULL, n=NA, ...) {
	UseMethod("mandel.h")
}

mandel.k <- function(x, g=NULL, m=NULL, na.rm=T, rowname=NULL, n=NA, ...) {
	UseMethod("mandel.k")
}

#Defaults:
mandel.h.default <- function(x, g=NULL, m=NULL, na.rm=T, rowname=NULL, n=NA, ...) {
	mkh<-mandel.kh(x=x, g=g, m=m, na.rm=na.rm, rowname=rowname, type="h", n=n, ...)
...
mandel.k.default <- function(x, g=NULL, m=NULL, na.rm=T, rowname=NULL, n=NA, ...) {
	mkh<-mandel.kh(x=x, g=g, m=m, na.rm=na.rm, rowname=rowname, type="k", n=n, ...)
...
#ilab methods
#
mandel.h.ilab <- function(x, g=NULL, m=NULL, na.rm=T, rowname=NULL, n=NA, ...) {
	...
	mkh<-mandel.kh(x=x$data$x, g=g, m=m, na.rm=na.rm, rowname=rowname, type="h", n=n, ...)
...
mandel.k.ilab <- function(x, g=NULL, m=NULL, na.rm=T, rowname=NULL, n=NA, ...) {
	...
	mkh<-mandel.kh(x=x$data$x, g=g, m=m, na.rm=na.rm, rowname=rowname, type="k", n=n, ...)
...
plot.mandel.kh <- function(x, main=paste("Mandel's", attr(x, "mandel.type") ), 
				probs=c(0.95, 0.99),
...
barplot.mandel.kh <- function(x, main=paste("Mandel's", attr(x, "mandel.type") ), 
				probs=c(0.95, 0.99),
				xlab=attr(x, "grouped.by"), ylab=attr(x, "mandel.type"),
